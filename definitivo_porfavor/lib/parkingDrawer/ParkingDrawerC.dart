...
class ParkingDrawerC extends StatefulWidget {
  @override
  _ParkingDrawerCState createState() => _ParkingDrawerCState();
}

class _ParkingDrawerCState extends State<ParkingDrawerC> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.blue[50],
        appBar: AppBar(title: Text('PARKING C')), body: _parkingAWidgetC());
  }

  Widget _parkingAWidgetC() {
              ...
              itemBuilder: (context, index) {
                ...
                return Column(
                  children: <Widget>[
                    Container(
                      height: 250,
                      child: Image.asset('assets/parkingC.png'),
                    ),
                     Row(
                      children: <Widget>[
                        Container(
